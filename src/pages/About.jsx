...
import pic1 from './pic1.jpg'; // Mobeen's image
import moizPic from './Moiz_2.JPG'; // Abdul Moiz's image
import husnainPic from './husnain.jpg'; // Husnain's image
...
const About = () => {
  ...
  const team = [
    ...
    },
    {
      name: 'Abdul Moiz',
      role: 'CTO',
      image: moizPic, // Abdul Moiz's local image
      description: 'AI specialist who previously worked at Google and Microsoft.'
    },
    {
      name: 'Husnain Ali',
      role: 'Head of Product',
      image: husnainPic, // Husnain's local image
